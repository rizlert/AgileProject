...
=======
	@FindBy (xpath = "//h1[contains(text(),'now activate your account!')]")
...
<<<<<<< HEAD
		EmailAddressField.sendKeys("sdaksndjkan@gmail.com");
=======
		EmailAddressField.sendKeys("ssf3124@gmail.com");
>>>>>>> 971344c (file added)
	}
...
<<<<<<< HEAD
	public void SignUpVerification() {
		Assert.assertEquals(SignUpCheck, "Thank you — now activate your account!", "signUP page Passed");
=======
	public void SignUpVerification()  {
